    ...
    return (
        <div className='bg-black text-white'>
            ...
            <div className="max-w-2xl mx-auto p-6 bg-black shadow-lg rounded-lg">
                ...
                <p className="text-gray-400">Topic: <span className="font-semibold">{quiz.topic?.name || 'No Topic'}</span></p>
                    ...
                    {questions.map((question) => (
                        <div key={question.id} className="mb-6 p-4 bg-black border border-gray-700 rounded-lg shadow-sm">
                            ...
                            <div className="space-y-2">
                                {Object.values(question.shuffled_options).map((option, index) => (
                                    <label
                                        key={index}
                                    ...
                                    >
                                        <input
                                            ...
                                            value={Object.keys(question.shuffled_options)[index]}
